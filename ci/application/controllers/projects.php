...
class Projects extends CI_Controller {
    ...
    public function create() {
        ...
        if($this->form_validation->run() == FALSE)  {
            ...
            if($this->project_model->create_project($data)) {
                ...
                $this->session->set_flashdata('project_created','Your project has beed created');
    ...
    public function edit($project_id) {
        ...
        if($this->form_validation->run() == FALSE)  {
            ...
            if($this->project_model->edit_project($project_id, $data)) {
                ...
                $this->session->set_flashdata('project_updated','Your project has beed updated');
                redirect("projects/index");
    ...
    public function delete($project_id) {
        ...
        $this->session->set_flashdata('project_deleted','Your project has beed deleted');
        redirect("projects/index");
